    ...
    buyables: {
        11: {
            ...
            cost(x) {
                ...
                let costscale = new Decimal(20).add(new Decimal(10).times(amt.Math.floor(amt.divide(10)).times(10)));
                return new Decimal(250).add(new Decimal(costscale).times(new Decimal(x)));
            },
            effect(x) {
